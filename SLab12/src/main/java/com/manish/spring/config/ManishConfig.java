...
public class ManishConfig {
	...
	@Bean("serv5")
	public Service getService5(@Qualifier("stud2") Student st,@Qualifier("emp2") Employee emp) {
		Service s = new Service();
		s.setStud(st);
		s.setEmp(emp);
		return s;
	...
	@Bean("serv6")
	public Service getService6(@Qualifier("stud2") Student st,@Qualifier("emp2") Employee emp) {
		Service s = new Service(st, emp);
		return s;
	}
